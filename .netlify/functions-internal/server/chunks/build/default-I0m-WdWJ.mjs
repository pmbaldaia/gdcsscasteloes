...
import { _ as _sfc_main$3 } from './NuxtImg-BJb9P2Je.mjs';
import { _ as _sfc_main$4 } from './ThemeToggle-D4EwCOnp.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-CVE1ktMt.mjs';
import { computed, mergeProps, unref, ref, watch, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, withAsyncContext, defineComponent, inject, createElementBlock, renderSlot, createCommentVNode, createElementVNode, useSSRContext } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const menuitems = [
      { title: "Sobre n\xF3s", path: "/sobre/" },
      { title: "Equipa", path: "/equipa/" },
      { title: "Calend\xE1rio", path: "/calendario/" },
      { title: "Eventos", path: "/eventos/" },
      { title: "Galeria", path: "/galeria/" },
      { title: "Oportunidades", path: "/oportunidades/" }
    ];
    const isActive = (item) => item.path === "/eventos/" ? route.path === "/eventos/" || route.path.startsWith("/eventos/") : route.path === item.path;
    watch(() => route.path, () => {
      open.value = false;
    });
      ...
      _push(ssrRenderComponent(_component_LandingContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></ul><div class="lg:hidden flex justify-center items-center pb-4 gap-5 w-full"${_scopeId}><a href="https://www.instagram.com/gdcsscasteloes/" aria-label="Instagram" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-primary-800 transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(F$2), { class: "w-6 h-6" }, null, _parent2, _scopeId));
            _push2(`</a><a href="https://www.facebook.com/gdcscasteloes/" aria-label="Facebook" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-primary-800 transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(G$1), { class: "w-6 h-6" }, null, _parent2, _scopeId));
            _push2(`</a><a href="https://www.tiktok.com/@gdcss.casteloes" aria-label="Facebook" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-primary-800 transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(F$1), { class: "w-6 h-6" }, null, _parent2, _scopeId));
            _push2(`</a></div></nav><div class="hidden lg:flex items-center gap-3 shrink-0"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ThemeToggle, null, null, _parent2, _scopeId));
            _push2(`<span class="h-5 w-px bg-neutral-200" aria-hidden="true"${_scopeId}></span><a href="https://www.instagram.com/gdcsscasteloes/" target="_blank" aria-label="Instagram" class="text-neutral-600 hover:text-primary-800 transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(F$2), { class: "w-5 h-5" }, null, _parent2, _scopeId));
            _push2(`</a><a href="https://www.facebook.com/gdcscasteloes/" target="_blank" aria-label="Facebook" class="text-neutral-600 hover:text-primary-800 transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(G$1), { class: "w-5 h-5" }, null, _parent2, _scopeId));
            _push2(`</a><a href="https://www.tiktok.com/@gdcss.casteloes" target="_blank" aria-label="Instagram" class="text-neutral-600 hover:text-primary-800 transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(F$1), { class: "w-5 h-5" }, null, _parent2, _scopeId));
            _push2(`</a></div></div></header>`);
          } else {
            return [
              createVNode("header", {
                class: [
                ...
                createVNode("div", {
                  ...
                  createVNode("nav", {
                      ...
                      (openBlock(), createBlock(Fragment, null, renderList(menuitems, (item) => {
                        return createVNode("li", {
                          ...
                          createVNode(_component_NuxtLink, {
                            ...
                            _: 2
                          }, 1032, ["to", "onClick", "aria-current", "class"])
                        ]);
                      }), 64))
                    ]),
                    createVNode("div", { class: "lg:hidden flex justify-center items-center pb-4 gap-5 w-full" }, [
                      createVNode("a", {
                        ...
                        createVNode(unref(F$2), { class: "w-6 h-6" })
                      ]),
                      createVNode("a", {
                        ...
                        createVNode(unref(G$1), { class: "w-6 h-6" })
                      ]),
                      createVNode("a", {
                        ...
                        createVNode(unref(F$1), { class: "w-6 h-6" })
                      ])
                    ])
                  ], 2),
                  createVNode("div", { class: "hidden lg:flex items-center gap-3 shrink-0" }, [
                    ...
                    createVNode("a", {
                      ...
                      createVNode(unref(F$2), { class: "w-5 h-5" })
                    ]),
                    createVNode("a", {
                      href: "https://www.facebook.com/gdcscasteloes/",
                      target: "_blank",
                      ...
                      createVNode(unref(G$1), { class: "w-5 h-5" })
                    ]),
                    createVNode("a", {
                      href: "https://www.tiktok.com/@gdcss.casteloes",
                      target: "_blank",
                      ...
                      createVNode(unref(F$1), { class: "w-5 h-5" })
                    ])
                  ])
                ], 2)
              ], 2)
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "site-footer w-full mt-12 bg-surface border-t border-neutral-200 py-10 sm:py-12 text-neutral-900" }, _attrs))}><div class="site-shell"><hr class="border-t border-neutral-200 my-6 w-full mx-auto"><div class="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-8"><div class="flex flex-col h-full justify-start text-left"><h3 class="text-fluid-xl font-bold mb-1">Sobre</h3><div class="w-[10%] border-b-2 border-secondary-800 mb-3"></div><p class="text-fluid-sm leading-relaxed text-neutral-600"> N\xF3s, enquanto equipa, temos a vis\xE3o de procurar sempre a vit\xF3ria e sermos os melhores em tudo o que fazemos. Treinamos com dedica\xE7\xE3o e foco para alcan\xE7ar o topo e demonstrar a nossa paix\xE3o pelo futebol em cada jogo. </p></div><div class="flex flex-col h-full justify-start text-left"><h3 class="text-fluid-xl font-bold mb-1">Links \xDAteis</h3><div class="w-[10%] border-b-2 border-secondary-800 mb-3"></div><ul class="space-y-3 text-fluid-sm"><li><a href="/contacto" class="transition-colors duration-300 text-neutral-600 hover:text-secondary-800 hover:underline" aria-label="Clica aqui para ver os contactos"> Contactos </a></li><li><a href="/politicas/cookies" class="transition-colors duration-300 text-neutral-600 hover:text-secondary-800 hover:underline" aria-label="Clica aqui para ver a pol\xEDtica de cookies"> Pol\xEDtica de Cookies </a></li><li><a href="/politicas/privacidade" class="transition-colors duration-300 text-neutral-600 hover:text-secondary-800 hover:underline" aria-label="Clica aqui para ver a pol\xEDtica de privacidade"> Pol\xEDtica de Privacidade </a></li><li><a href="/politicas/servico" class="transition-colors duration-300 text-neutral-600 hover:text-secondary-800 hover:underline" aria-label="Clica aqui para ver os termos de servi\xE7o"> Termos de Servi\xE7o </a></li><li><a href="/politicas/servico" class="transition-colors duration-300 text-neutral-600 hover:text-secondary-800 hover:underline" aria-label="Clica aqui para ver os termos de servi\xE7o"> Termos de Servi\xE7o </a></li><li><a href="/pdf/manual-acolhimento-boas-praticas.pdf" target="_blank" rel="noopener noreferrer" class="transition-colors duration-300 text-neutral-600 hover:text-secondary-800 hover:underline" aria-label="Clica aqui para ver o Manual de Acolhimento e Boas Pr\xE1ticas"> Manual de Acolhimento e Boas Pr\xE1ticas </a></li></ul></div><div class="flex flex-col h-full justify-start text-left"><h3 class="text-fluid-xl font-bold mb-1">Redes Sociais</h3><div class="w-[10%] border-b-2 border-secondary-800 mb-3"></div><ul class="space-y-3 text-fluid-sm"><li><a href="https://www.facebook.com/gdcscasteloes/" target="_blank" class="flex items-center space-x-2 text-neutral-600 hover:text-secondary-800 hover:underline transition-colors duration-300" aria-label="Clica aqui para aceder ao Facebook">`);
      _push(ssrRenderComponent(unref(G$1), { class: "w-6 h-6 fill-current" }, null, _parent));
      _push(`<span>Facebook</span></a></li><li><a href="https://www.instagram.com/gdcsscasteloes/" target="_blank" class="flex items-center space-x-2 text-neutral-600 hover:text-secondary-800 hover:underline transition-colors duration-300" aria-label="Clica aqui para aceder ao Instagram">`);
      _push(ssrRenderComponent(unref(F$2), { class: "w-6 h-6 fill-current" }, null, _parent));
      _push(`<span>Instagram</span></a></li></ul></div><div class="flex flex-col h-full justify-start text-left"><h3 class="text-fluid-xl font-bold mb-1">Contacto</h3><div class="w-[10%] border-b-2 border-secondary-800 mb-3"></div>`);
...
//# sourceMappingURL=default-I0m-WdWJ.mjs.map
