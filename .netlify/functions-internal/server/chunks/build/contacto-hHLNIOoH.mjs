...
import __nuxt_component_0$1 from './Icon-DZ18AjZn.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_LandingSectionhead, null, {
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col items-center"${_scopeId2}><span class="text-neutral-900"${_scopeId2}>Contacto</span><div class="mt-5 w-32 h-px flex rounded-sm overflow-hidden"${_scopeId2}><div class="w-1/2 bg-secondary-500"${_scopeId2}></div><div class="w-1/2 bg-primary-700"${_scopeId2}></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex flex-col items-center" }, [
                      createVNode("span", { class: "text-neutral-900" }, "Contacto"),
              ...
              desc: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="text-neutral-600"${_scopeId2}> Preenche o formul\xE1rio e entra em contacto connosco. </p><p class="text-neutral-600 mt-2"${_scopeId2}> Envia-nos uma mensagem ou email. Respondemos o mais r\xE1pido poss\xEDvel! </p>`);
                } else {
                  return [
                    createVNode("p", { class: "text-neutral-600" }, " Preenche o formul\xE1rio e entra em contacto connosco. "),
                    createVNode("p", { class: "text-neutral-600 mt-2" }, " Envia-nos uma mensagem ou email. Respondemos o mais r\xE1pido poss\xEDvel! ")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=contacto-hHLNIOoH.mjs.map
