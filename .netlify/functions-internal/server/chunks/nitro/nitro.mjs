...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "41d4561d-0fa9-4e75-8c82-85a6fb665c96",
  ...
  "public": {
    ...
    "nuxt-robots": {
      ...
      "sitemap": [
        "https://gdcsscasteloes.pt/sitemap.xml",
        "/sitemap.xml"
      ],
      "header": true,
...
const _4Q7j83HAduGshABUsiSKQdtlqQhPaouXtp4ohUvUDk = defineNitroPlugin(async (nitroApp) => {
...
const _PRCi37ef8vMMhk4MOIQxCxEGUBXWJfHHE5iuZ41xWM = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _4Q7j83HAduGshABUsiSKQdtlqQhPaouXtp4ohUvUDk,
_PRCi37ef8vMMhk4MOIQxCxEGUBXWJfHHE5iuZ41xWM
];
...
const _Lws08L = eventHandler(async (e) => {
...
const _MpENXS = defineEventHandler(async (e) => {
...
const _Zj3VLb = defineEventHandler(sitemapXmlEventHandler);

const _MPlkyF = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _75Ko1I = defineEventHandler(async (e) => {
...
const _zSIjfi = lazyEventHandler(() => {
...
const _lazy_PfPctP = () => import('../routes/api/_...path_.mjs');
const _lazy_Vn5Gn8 = () => import('../routes/uploads/_...path_.get.mjs');
const _lazy_camJ4L = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/**:path', handler: _lazy_PfPctP, lazy: true, middleware: false, method: undefined },
  { route: '/uploads/**:path', handler: _lazy_Vn5Gn8, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_camJ4L, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _Lws08L, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _MpENXS, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Zj3VLb, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _MPlkyF, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _75Ko1I, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _zSIjfi, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_camJ4L, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, getRequestHeader as A, destr as B, isEqual as C, getContext as D, setCookie as E, getCookie as F, deleteCookie as G, baseURL as H, defu as I, createHooks as J, executeAsync as K, defuFn as L, withLeadingSlash as M, encodeParam as N, parseQuery as O, withTrailingSlash as P, withoutTrailingSlash as Q, handler as R, getHeader as a, setHeader as b, createError$1 as c, defineEventHandler as d, sendStream as e, buildAssetsURL as f, getRouterParam as g, encodePath as h, defineRenderHandler as i, getQuery as j, getRouteRules as k, getResponseStatusText as l, getResponseStatus as m, useNitroApp as n, parseURL as o, publicAssetsURL as p, decodePath as q, readBody as r, setResponseStatus as s, hasProtocol as t, useRuntimeConfig as u, isScriptProtocol as v, joinURL as w, withQuery as x, klona as y, sanitizeStatusCode as z };
