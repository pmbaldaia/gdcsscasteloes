...
import { withAsyncContext, computed, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_CmsManagedPageHeader, {
              "page-slug": "eventos",
              "fallback-title": "Pr\xF3ximos Eventos",
              "fallback-description": "N\xE3o percas as nossas pr\xF3ximas festas e eventos! Vem divertir-te connosco!"
...
//# sourceMappingURL=index-djtWk9lG.mjs.map
