...
import './rest.repository-Cx9D2HNC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fields = [{ key: "name", label: "Nome" }, { key: "logo", label: "Logo", type: "image", placeholder: "/logos/equipa.webp" }, { key: "status", label: "Estado", type: "select", options: [{ value: "published", label: "Publicado" }, { value: "draft", label: "Rascunho" }] }];
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CmsResourceManager, mergeProps({
        ...
        title: "Equipas",
        description: "Clubes e caminhos dos log\xF3tipos consumidos pelos jogos.",
        fields,
        columns: ["name", "logo"]
      }, _attrs), null, _parent));
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/equipas.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=equipas-uFXQJrMP.mjs.map
